...
const Command = React.forwardRef(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex overflow-hidden flex-col w-full h-full bg-white rounded-md text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50',
      className,
    )}
    {...props}
  />
...
const CommandInput = React.forwardRef(({ className, ...props }, ref) => (
  ...
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex py-3 w-full h-10 text-sm bg-transparent rounded-md outline-none placeholder:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-neutral-400',
        className,
      )}
      {...props}
    />
